...
private fun WasmOp.pureStacklessInstruction() = when (this) {
    WasmOp.GET_UNIT, WasmOp.REF_NULL, WasmOp.I32_CONST, WasmOp.I64_CONST, WasmOp.F32_CONST, WasmOp.F64_CONST, WasmOp.LOCAL_GET -> true
    else -> false
}
...
class WasmIrExpressionBuilder(
    ...
    private var lastInstr: WasmInstr? = null

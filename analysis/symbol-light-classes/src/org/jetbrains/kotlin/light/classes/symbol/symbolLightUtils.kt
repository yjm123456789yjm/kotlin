...
internal fun KtSymbolWithVisibility.toPsiVisibilityForClass(): String =
    visibility.toPsiVisibilityForClass()
...
private fun Visibility.toPsiVisibilityForClass(): String {
    return when (this) {
        Visibilities.Public,

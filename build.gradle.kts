    ...
    register("publishIdeArtifacts") {
        idePluginDependency {
            dependsOn(
                ...
                ":prepare:ide-plugin-dependencies:kotlin-jps-common-for-ide:publish",
                ":prepare:ide-plugin-dependencies:kotlin-jps-plugin-classpath:publish",
    ...
    register("installIdeArtifacts") {
        idePluginDependency {
            dependsOn(
                ...
                ":prepare:ide-plugin-dependencies:kotlin-jps-common-for-ide:install",
                ":prepare:ide-plugin-dependencies:kotlin-jps-plugin-classpath:install",

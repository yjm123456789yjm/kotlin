...
@DslMarker
internal annotation class KotlinTargetPresetFunctionsDsl

@KotlinTargetPresetFunctionsDsl
interface KotlinTargetContainerWithPresetFunctions : KotlinTargetsContainerWithPresets {
    ...
    fun iosSimulatorArm64(name: String, configure: Action<KotlinNativeTargetWithSimulatorTests>) =
    ...
    fun watchosSimulatorArm64(name: String, configure: Action<KotlinNativeTargetWithSimulatorTests>) =
    ...
    fun tvosSimulatorArm64(name: String, configure: Action<KotlinNativeTargetWithSimulatorTests>) =

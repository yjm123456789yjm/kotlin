...
internal class KotlinRootNpmResolver internal constructor(
    ...
    @Transient
    private val yarnHome_: Provider<File>? = rootProject_.provider {
        YarnPlugin.apply(rootProject_).requireConfigured().home
    }
    ...
    private val resolverStateHolder by lazy {
        rootProject_.gradle.sharedServices.registerIfAbsent(
            ...
            it.parameters.yarnHome.set(yarnHome_?.get())
    ...
    private val yarnHome
        get() = yarnHome_?.get() ?: resolverStateHolder.get().parameters.yarnHome.get()

...
fun KotlinJsOptions.isProduceUnzippedKlib() = freeCompilerArgs.get().isProduceUnzippedKlib()
fun List<String>.isProduceUnzippedKlib() = PRODUCE_UNZIPPED_KLIB in this

...
internal class KtUltraLightEnumEntry(
    ...
    private val _initializingClass by lazyPub {
        enumEntry.body?.let { KtUltraLightClassForEnumEntry(enumEntry, this.support, this) }
    }
    ...
    override fun copy(): PsiElement = KtUltraLightEnumEntry(declaration as KtEnumEntry, name, containingClass, support, modifiers)
}
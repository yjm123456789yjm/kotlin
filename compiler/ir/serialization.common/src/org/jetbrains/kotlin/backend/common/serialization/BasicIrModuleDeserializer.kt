...
abstract class BasicIrModuleDeserializer(
    ...
    open fun createFileDeserializationState(
        file: IrFile, fileReader: IrLibraryFile, fileProto: ProtoFile, fileIndex: Int, moduleDeserializer: IrModuleDeserializer, allowErrorNodes: Boolean, fileStategy: DeserializationStrategy
    ...
    private fun deserializeIrFile(fileProto: ProtoFile, fileIndex: Int, moduleDeserializer: IrModuleDeserializer, allowErrorNodes: Boolean): IrFile {
        ...
        val fileDeserializationState = createFileDeserializationState(file, fileReader, fileProto, fileIndex, moduleDeserializer, allowErrorNodes, fileStrategy)

...
abstract class ExpressionCheckers {
    ...
    open val jumpCheckers: Set<FirJumpChecker> = emptySet()
    ...
    @CheckersComponentInternal internal val allJumpCheckers: Set<FirJumpChecker> by lazy { jumpCheckers + basicExpressionCheckers }
    ...
    @CheckersComponentInternal internal val allLoopJumpCheckers: Set<FirLoopJumpChecker> by lazy { loopJumpCheckers + jumpCheckers + basicExpressionCheckers }
    ...
    @CheckersComponentInternal internal val allReturnExpressionCheckers: Set<FirReturnExpressionChecker> by lazy { returnExpressionCheckers + jumpCheckers + basicExpressionCheckers }

...
class Fir2IrDeclarationStorage(
    ...
    fun createIrFunction(
        ...
        val signature =
            ...
            else signatureComposer.composeSignature(function, containingClass, forceTopLevelPrivate)
    ...
    fun createIrProperty(
        ...
        val signature =
            ...
            else signatureComposer.composeSignature(property, containingClass, forceTopLevelPrivate)
        if (irParent is Fir2IrLazyClass && signature != null) {

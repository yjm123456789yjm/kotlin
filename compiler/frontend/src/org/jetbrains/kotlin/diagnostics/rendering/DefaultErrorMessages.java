...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(BUILDER_INFERENCE_OFF, "Builder inference does not work here");
        MAP.put(BUILDER_INFERENCE_STUB_RECEIVER, "Builder inference works unstable here due to stub receiver");

...
public interface Errors {
    ...
    DiagnosticFactory0<PsiElement> BUILDER_INFERENCE_OFF = DiagnosticFactory0.create(ERROR);
    DiagnosticFactory0<PsiElement> BUILDER_INFERENCE_STUB_RECEIVER = DiagnosticFactory0.create(ERROR);

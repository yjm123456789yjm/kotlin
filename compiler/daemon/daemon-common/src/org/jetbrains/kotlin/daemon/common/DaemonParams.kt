...
fun configureDaemonJVMOptions(opts: DaemonJVMOptions,
    ...
    if (inheritAdditionalProperties) {
        ...
        CompilerSystemProperties.COMPILE_INCREMENTAL_WITH_ABI_SNAPSHOTS.value?.let { opts.jvmParams.add("D${CompilerSystemProperties.COMPILE_INCREMENTAL_WITH_ABI_SNAPSHOTS.property}") }
    }

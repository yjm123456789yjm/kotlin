...
// Here we generate 1 clause in `$deserializeLambda$` for each serialized lambda in source code,
// even though some of those clauses could be merged into one.
// javac also doesn't bother with such optimizations, though, so we don't care much.

// CHECK_BYTECODE_TEXT
// JVM_IR_TEMPLATES
// 16 java/lang/invoke/LambdaMetafactory
// 1 TABLESWITCH
// 40 java/lang/Object\.equals
